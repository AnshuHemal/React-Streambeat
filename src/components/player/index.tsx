...
import { MiniProgressBar, ProgressBar } from "./ProgressBar";
...
function PlayerComponent() {
  ...
  // Track sticky header visibility for pointer events
  useEffect(() => {
      ...
      >
        ...
        >
          ...
          <View style={{ paddingHorizontal: 24 }}>
            ...
            <ProgressBar />
            <Controls onLayout={setControlsY} />
